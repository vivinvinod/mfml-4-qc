...
.. GENERATED FROM PYTHON SOURCE LINES 100-167
...
.. image-sg:: /auto_examples/images/sphx_glr_08_pool_based_active_learning_001.png
   :alt: Active Learning on MD-Benzene (LC-DFTB)
   :srcset: /auto_examples/images/sphx_glr_08_pool_based_active_learning_001.png
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 24.321 seconds)

**Estimated memory usage:**  197 MB
